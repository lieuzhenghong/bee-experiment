...
.btn-custom {
  background-color: hsl(174, 48%, 19%) !important;
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#46beb2", endColorstr="#194743");
  background-image: -khtml-gradient(linear, left top, left bottom, from(#46beb2), to(#194743));
  background-image: -moz-linear-gradient(top, #46beb2, #194743);
  background-image: -ms-linear-gradient(top, #46beb2, #194743);
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #46beb2), color-stop(100%, #194743));
  background-image: -webkit-linear-gradient(top, #46beb2, #194743);
  background-image: -o-linear-gradient(top, #46beb2, #194743);
  background-image: linear-gradient(#46beb2, #194743);
  border-color: #194743 #194743 hsl(174, 48%, 11%);
  color: #fff !important;
