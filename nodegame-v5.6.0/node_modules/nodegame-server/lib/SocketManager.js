 ...
 *
 * @param {string} sid A socket id
 *
 * @return {boolean} TRUE, if the socket id belongs to a remote connection
 */
SocketManager.prototype.isRemote = function(sid) {
    return sid.charAt(0) === 'S';
};
