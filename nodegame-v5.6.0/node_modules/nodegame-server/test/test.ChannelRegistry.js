...
// console.log('All SIDs: ', chReg.getSids());
// console.log('All players: ', chReg.getPlayers());
// console.log('All admins: ', chReg.getAdmins());
// console.log('All connected clients: ', chReg.getConnected());
// console.log('All disconnected clients: ', chReg.getDisconnected());
